...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'guai@xiaoxinxin.onmicrosoft.com',
  ...
  protectedRoutes: ['/share/mi', '/mi', '/others', '/share/others', '/BabyEnlightenment', '/ielts'],
